...
Welcome to the Database Management textbook at the University of Illinois.
...
1. **Understand and articulate** the data needs of a company (requirement analysis)
2. **Conceptually model** the relationship of data (data modeling)
3. **Query databases** using SQL to meet business requirements (structured and non-relational)
4. **Extract, Transform, and Load (ETL)** data from/to multiple sources
5. **Understand infrastructure needs** to handle Big Data and build BI and ML workflows
...
This textbook is organized to follow the weekly progression of the course:
...
Each chapter includes hands-on labs using real-world scenarios in:
- Marketing (customer data management)
- Supply Chain (vendor performance analysis)
- Finance (macroeconomic research)
...
Start with [Chapter 1: Database Environment](chapters/01-database-environment.md) or explore the [Labs](labs/setup.md) section to set up your development environment.
